...
Work by others that APL Art includes or depends on, and the terms it is used under.
This file is documentation: nothing here is shown inside the application.

## Hugeicons

Hugeicons — used under licence.

Some of the interface icons used by APL Art are based on Hugeicons:
